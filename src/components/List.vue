<template>
	<div>
		...
		<group >
			<cell :title="'影史100个经典角色'" is-link></cell>
			<scroller lock-y :scrollbar-x=false>
				<div class="box1"  :style="{width: salewidth}">
					<div class="box1-item" v-for="(item, index) in editList.list" :key="index">
		...
		<group >
			<cell :title="'影史上的今天'" is-link></cell>
			<scroller lock-y :scrollbar-x=false>
...
<script>
	...
	export default {
		...
		methods: {
			...
			getData(){
				this.$axios.get("../../../static/film_list.js").then(response => {
